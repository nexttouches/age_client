package ageb.modules.avatar.timelineClasses
{
	...
	import ageb.modules.avatar.op.DragReorderFrameLayerOP;
	...
	public class FrameLayerList extends List
	{
		...
		*/
		override protected function dragDropHandler(event:DragEvent):void
		{
			...
			var op:DragReorderFrameLayerOP = new DragReorderFrameLayerOP(Modules.getInstance().document.currentDoc, dropIndex, caretIndex, items, event.action, this);
			op.execute();
		}
