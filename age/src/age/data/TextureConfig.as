package age.data
{
	...
	/**
	 * TextureConfig 按 path 储存了所有的 TextureAtlas 信息
	 * @author zhanghaocong
	 *
	 */
	public class TextureConfig
	{
		 ...
		 *
		 */
		public static function init(json:String, folder:String):void
		{
			_list = JSON.parse(json).list;
			_folder = folder;
		}
	}
}
